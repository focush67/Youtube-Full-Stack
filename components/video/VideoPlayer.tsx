...
const VideoPlayer: React.FC<VideoPlayerProps> = ({ videoSrc }) => {
  ...
  return (
    <div className="relative w-full max-w-[1000px] flex justify-center m-auto group bg-black">
      <div
        className={`absolute bottom-0 left-0 right-0 text-white bg-gradient-to-t from-black/40 z-10 opacity-5 transition-opacity group-hover:opacity-100 cursor-pointer`}
      >

        <div className="cursor-pointer flex items-center mx-2 h-2 group/timeline">
            <div className={`w-full relative bg-gray-500 opacity-50 hover:opacity-100 h-1 group:hover/timeline:h-full`}>
                <span className="absolute left-0 top-0 bottom-0 bg-red-600">

                </span>
                
                <div className="scale-0 group-hover/timeline:scale-100 absolute h-[200%] aspect-square bg-red-600 rounded-full translate-x-[-50%] top-[-50%]">
